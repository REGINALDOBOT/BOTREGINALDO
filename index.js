...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				aguarde : 'calmaer espere 2minutos enquanto isso beba agua',
				...
				error: {
					stick: '[â—] Falha, ocorreu um erro ao converter a imagem em um adesivo so faço adesivo de 6segundos a menos âŒ',
				...
				only: {
					...
					proprietárioB : '[â -] Este comando sÃ³ pode ser usado pelo DANTE aquele gostoso!  Œ ' ,
					admin : '[â  -] Este comando sÃ³ pode ser usado pelos administradores de grupo retardado! uma Œ ' ,
					Badmin: '[â—] Este comando sÃ³ pode ser usado quando o bot se torna administrador animal ! âŒ',
			...
			const ownerNumber = ["557582692667@s.whatsapp.net"] // replace this with your number
			const  nomorOwner  = [ 5533999455861 ]
